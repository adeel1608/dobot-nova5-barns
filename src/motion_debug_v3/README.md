...
| `dobot_msgs_v3/msg/ToolVectorActual` | `dobot_msgs_v3/msg/ToolVectorActual` |
| `dobot_msgs_v3/msg/RobotStatus` | `dobot_msgs_v3/msg/RobotStatus` |
...
- `DisableRobot`
- `ClearError`
- `ResetRobot`  (V3 replacement for the V4 `Stop` usage in this GUI)
- `MoveJog`  (V3 replacement for the V4 `StopMoveJog` usage in this GUI)
- `StartDrag`
- `StopDrag`
- `Tool`
- `SetPayload`
