...
def test_functionality(**params):
    ...
    run_skill("sync")
    run_skill("gotoJ_deg", *ESPRESSO_HOME)
    run_skill("approach_machine", "three_group_espresso", "port_3")
    run_skill("sync")
    run_skill("mount_machine", "three_group_espresso", "port_3")
    run_skill("sync")
    # run_skill("move_to", "portafilter_cleaner", 0.22)
    # run_skill("get_machine_position", "three_group_espresso")
    # run_skill("release_tension")
    # print(run_skill("inverse_solution", -186.00,-366.00,458.00,-90.00,-0.00,-90.00))
    # print(run_skill("positive_solution", -100.63,-0.95,-97.47,-92.69,-102.41,-184.84))
    # run_skill("gotoJ_deg", -100.63,-5.36,-111.04,-74.72,-102.4,-184.84)
    # run_skill("sync")
    # run_skill("gotoJ_deg", -80.63,-5.36,-111.04,-74.72,-102.4,-184.84)
    # run_skill("sync")
    # run_skill("gotoJ_deg", -100.63,-5.36,-111.04,-74.72,-102.4,-184.84)
    # run_skill("sync")
    # run_skill("set_gripper_position", 100, 0, 100)
    # run_skill("set_speed_factor", 100)
    # run_skill("enforce_rxry")
    # run_skill("enforce_rxry_angled")
    # run_skill("moveEE", 0, 0, -10, 0, 0, 0)
    # run_skill("moveJ_deg", 10, 0, 0, 0, 0, 0)
    # run_skill("gotoEE",-186.82,-366.61,458.73,-101.12,-2.4,-177.46)
    # run_skill("gotoJ_deg", -109.689871,-32.054909,-104.983074,-222.263507,-160.381666,-359.347571)
    # run_skill("approach_tool")
    # run_skill("approach_machine")
    # run_skill("mount_machine")
    # run_skill("grab_tool")
    # run_skill("set_DO")
    # run_skill("toggle_drag_mode")
    # run_skill("current_angles")
    # run_skill("current_pose")
    # run_skill("moveEE_movJ")
    # run_skill("gotoEE",-484.38,-132.08,299.97,115.38,-8.34,-47.74)
    # run_skill("gotoEE",-102.63,-304.16,516.44,121.5,-5.21,9.9)
    # run_skill("sync")
    # run_skill("gotoEE_movJ",-484.38,-132.08,299.97,115.38,-8.34,-47.74)
    # run_skill("gotoEE_movJ",-102.63,-304.16,516.44,121.5,-5.21,9.9)
    # run_skill("move_portafilter_arc_movJ",40)
    # run_skill("move_portafilter_arc_tool_angled", -40.0)
...
SEQUENCES = {
    ...
    "test_functionality": lambda: test_functionality(),
}
