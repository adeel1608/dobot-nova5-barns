...
- ID: `0x110`
- DLC: 8
- Payload bytes: `[cmd] [motor_id] [weight_dg_low] [weight_dg_high] [liquid_type] [0x00] [0x00] [0x00]`
  - `cmd`: `0x01` = dispense
  - `motor_id`: 1..24 (see map below)
  - `weight_dg`: target weight in decigrams, little‑endian (10 g → 100 dg → `0x0064` → LL=`0x64`, HH=`0x00`)
  - `liquid_type`: `1` water, `2` milk, `3` sauce, `4` caramel, `5` syrup, `6` honey
