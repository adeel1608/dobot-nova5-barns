...
def clean(**params) -> bool:
    ...
    try:
        ...
        clean_motion1 = run_skill("moveEE", 0, 0, -5, 0, 0, 0)
        ...
        clean_motion2 = run_skill("moveEE", 0, 0, -5, 0, 0, 0)
        ...
        soft_clean1 = run_skill("moveEE", 0, 0, -5, 0, 0, 0)
        ...
        soft_clean2 = run_skill("moveEE", 0, 0, -5, 0, 0, 0)
