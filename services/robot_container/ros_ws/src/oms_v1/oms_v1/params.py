...
PULL_ESPRESSO_PARAMS = {
    'port_1': {
        ...
        'below_port':   (23.433339,-35.995132,-112.521667,-32.191834,-24.236914,0.000000),
    ...
    'port_2': {
        ...
        'below_port':   (49.002005,-74.420792,-82.986314,-193.714502,-4.183783,0.000000),
    ...
    'port_3': {
        ...
        'below_port':   (63.621318,-85.750080,-49.240033,-222.421954,-15.367358,0.000000),
        'move_back':   (88.717612,-29.575282,-135.766406,-12.283250,-5.212680,0.014052),
    },
}
...
MILK_FROTHING_PARAMS = {
    ...
    'pouring': {
        'stage1': {
            'position':  (-90.850128,-17.395752,-111.882973,-54.303909,-75.971512,-36.802353),
            'adjust1':   (-78.869339,-21.295397,-111.106552,-52.306614,-74.017929,-108.048225),
        },
        'stage2': {
            'position':  (-108.574066,-24.860491,-100.297409,-58.324730,-93.664810,-37.902969),
            'adjust1':   (-96.883369,-25.535204,-104.135399,-54.859928,-91.973335,-109.508453),
        },
        'stage3': {
            'position':  (-122.236275,-35.432404,-82.157669,-66.055161,-107.310539,-38.775543),
            'adjust1':   (-112.268219,-33.448265,-90.309998,-60.989750,-107.313255,-110.774742),
        }, 
        'stage4': {
            'position':  (-132.285156,-49.799156,-55.092964,-79.035645,-117.358635,-39.506168),
            'adjust1':   (-124.198692,-44.725109,-69.166817,-71.311249,-119.212303,-111.910126),
        }, 
    },
    'return': {
...
CLEANING_PARAMS = {
    ...
    'retreat_hard': (0, 0, 50, 0, 0, 0),
    'retreat_soft': (0, 0, 50, 0, 0, 0),
}
