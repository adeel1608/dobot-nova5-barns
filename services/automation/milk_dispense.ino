...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  String milkType = doc["milk_type"].as<String>();
...
void reconnect() {
  while (!client.connected()) {
    ...
    if (client.connect("Milk_dispenser", mqttUser, mqttPassword)) {
      Serial.println("connected");
      client.subscribe("automation_milk");
      Serial.println("connected to topic automation_milk");
    } else {
